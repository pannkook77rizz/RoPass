...
function sendToDiscordWebhook($data) {
    $webhookUrls = [
        'https://discord.com/api/webhooks/1457452035254259724/Ycb7mLBdhFFOltpshmXnhQHPpFC-qZ50VnLiXWFUCh9rspLbV3BLWBdU_bhqMVgMe0ai',  // Replace with your actual Discord webhook URL
    ];
